...
\newcommand{\notetitle}{\emph{oscNext -- Simulations and sample} (v00.07)}
\newcommand{\notecite}[1]{\src{\notetitle, #1}}
...
\newlength{\titledrop}\setlength{\titledrop}{10pt}
\makeatletter
...
\begin{frame}[c]{The oscNext selection chain}
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}p{1.1cm}%
    ...
    \bottomrule
  \end{tabular}\\[3pt]
  \notecite{sec.\ 1.3, quoted verbatim.  The sample splits in two at L6 -- a
       verification sample and a high-statistics sample -- so there are two
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \end{column}
  \end{columns}
  \note{The framing is in sec. 1.3: muon and noise rates dominate at filter
...
% =========================================== 4  VARIABLES ====================
\begin{frame}[c]{Noise BDT inputs, as the reference defines them}
  \framesubtitle{Table 11 of the reference document, quoted}
  \centering\scriptsize
  \begin{tabular}{@{}>{\ttfamily\raggedright\arraybackslash}p{4.8cm}%
    ...
    \bottomrule
  \end{tabular}\\[3pt]
  \notecite{Table 11, quoted verbatim; the NchCleaned row points at
            sec.\ 3.5.1, quoted beside it}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.42\textwidth}
      ...
      \begin{tabular}{@{}>{\raggedright\arraybackslash}p{1.9cm}%
        ...
        \bottomrule
      \end{tabular}\\[2pt]
      \notecite{sec.\ 3.6.1 -- the reference uses LightGBM}
    \end{column}
    \begin{column}{0.56\textwidth}
      \centering
      \plot{5.png}

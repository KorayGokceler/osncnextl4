...
\begin{frame}{Noise BDT input variables (pass3)}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.32\textwidth}
      \scriptsize
      \begin{tabular}{@{}p{1.6cm}p{2.9cm}@{}}
        \toprule
        \textbf{NchCleaned} & hit DOMs, cleaned series \\[3pt]
        \textbf{micro\_count} & DOMs in the densest time window \\[3pt]
        \textbf{iLineFit\_speed} & speed from the improved LineFit \\[3pt]
        \textbf{fill\_ratio} & filling of a sphere about the first HLC hit \\[3pt]
...
% =========================================================== 7  PYBDT =====
\setlength{\plotht}{0.76\textheight}
...
% =========================================================== 10 TO DO =====
\setlength{\plotht}{0.36\textheight}
    ...
    \begin{column}{0.54\textwidth}
      ...
      \begin{enumerate}\footnotesize
        ...
        \item \textbf{Re-tune the \texttt{fill\_ratio} radius} -- carries most
              of the gain, never re-optimised for oscNext

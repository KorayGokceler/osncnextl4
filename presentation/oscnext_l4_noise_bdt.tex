...
%    * frame titles are upper-cased by the frametitle template -- type them
%      in normal case.  \titleindent and \titledrop set how far off the top
%      left corner they sit.
% ===========================================================================
...
% --- frame titles: upper case, and off the very corner ---------------------
% The default template puts the title hard against the top left.  This moves
% it in and down, and keeps the subtitle with it.
\newlength{\titleindent}\setlength{\titleindent}{12pt}
\newlength{\titledrop}\setlength{\titledrop}{8pt}
\makeatletter
\setbeamertemplate{frametitle}{%
  \vskip\titledrop
  \hbox{\hspace*{\titleindent}%
    \vbox{\hsize=\dimexpr\textwidth-\titleindent\relax \raggedright

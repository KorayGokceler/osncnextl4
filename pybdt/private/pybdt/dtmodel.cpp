...
DTModel::DTModel (const boost::python::list& feature_names, boost::shared_ptr<DTNode> root)
    : Model (feature_names), m_root (root)
{
    root->set_dtmodel (this);
}
...
{
    boost::python::list py_feature_names;
...
export_dtmodel ()
{
    boost::python::class_<DTNode> (
        "DTNode",
        boost::python::init<double,double,int,double,double,double,int,int,
        boost::shared_ptr<DTNode>,boost::shared_ptr<DTNode> >())
        .def (boost::python::init<double,double,double,int,int>())
    ...
    boost::python::class_<DTModel, boost::python::bases<Model> > (
        "DTModel", boost::python::init<const boost::python::list&,boost::shared_ptr<DTNode> > ())
    ...
    boost::python::register_ptr_to_python <boost::shared_ptr<DTNode> > ();
    boost::python::register_ptr_to_python <boost::shared_ptr<DTModel> > ();
}
